 ...
 */
 ...
 public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
 {
     ...
     {
        new Thread(new Bob(0,0,"yellow",400)).start();
        new Thread(new Bob(150, 150, "orange",400)).start();
        new Thread(new Bob(-150, 125, "red",400)).start();
        new Thread(new Bob(10, 250, "pink",400)).start();
        new Thread(new Bob(60, 90, "red",400)).start();
